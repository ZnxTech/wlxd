...
// for e.g. node with an xid_min of 128 will store all XIDs from and including 128 to 255
// in addition a node's XID range is always snapped to jumps sized NODE_RANGE to avoid overlaps
// e.g. 0 to 127, 128 to 255, 512 to 639, etc.
